...
namespace Prague_Buss_Parking
{
	class Program
	{
		...
		static readonly string bloodyPrague =
		" ██▓███   ██▀███  ▄▄▄        ▄████  █    ██ ▓█████ \n" +
		"▓██░  ██▒▓██ ▒ ██▒████▄     ██▒ ▀█▒ ██  ▓██▒▓█   ▀ \n" +
		"▓██░ ██▓▒▓██ ░▄█ ▒██  ▀█▄  ▒██░▄▄▄░▓██  ▒██░▒███   \n" +
		"▒██▄█▓▒ ▒▒██▀▀█▄ ░██▄▄▄▄██ ░▓█  ██▓▓▓█  ░██░▒▓█  ▄ \n" +
		...
		static readonly string bloodyParking =
		" ██▓███   ▄▄▄       ██▀███   ██ ▄█▀ ██▓ ███▄    █   ▄████ \n" +
		"▓██░  ██▒▒████▄    ▓██ ▒ ██▒ ██▄█▒ ▓██▒ ██ ▀█   █  ██▒ ▀█▒\n" +
		"▓██░ ██▓▒▒██  ▀█▄  ▓██ ░▄█ ▒▓███▄░ ▒██▒▓██  ▀█ ██▒▒██░▄▄▄░\n" +
		"▒██▄█▓▒ ▒░██▄▄▄▄██ ▒██▀▀█▄  ▓██ █▄ ░██░▓██▒  ▐▌██▒░▓█  ██▓\n" +
		...
		"░░         ░   ▒     ░░   ░ ░ ░░ ░  ▒ ░   ░   ░ ░ ░ ░   ░ \n" +
		"               ░  ░   ░     ░  ░    ░           ░       ░ \n";
		static readonly string bloodyPragueParking =
	" ██▓███   ██▀███  ▄▄▄        ▄████  █    ██ ▓█████ " + " ██▓███   ▄▄▄       ██▀███   ██ ▄█▀ ██▓ ███▄    █   ▄████ \n" +
	"▓██░  ██▒▓██ ▒ ██▒████▄     ██▒ ▀█▒ ██  ▓██▒▓█   ▀ " + "▓██░  ██▒▒████▄    ▓██ ▒ ██▒ ██▄█▒ ▓██▒ ██ ▀█   █  ██▒ ▀█▒\n" +
	"▓██░ ██▓▒▓██ ░▄█ ▒██  ▀█▄  ▒██░▄▄▄░▓██  ▒██░▒███   " + "▓██░ ██▓▒▒██  ▀█▄  ▓██ ░▄█ ▒▓███▄░ ▒██▒▓██  ▀█ ██▒▒██░▄▄▄░\n" +
	"▒██▄█▓▒ ▒▒██▀▀█▄ ░██▄▄▄▄██ ░▓█  ██▓▓▓█  ░██░▒▓█  ▄ " + "▒██▄█▓▒ ▒░██▄▄▄▄██ ▒██▀▀█▄  ▓██ █▄ ░██░▓██▒  ▐▌██▒░▓█  ██▓\n" +
	...
	"            ░          ░  ░      ░    ░        ░  ░" + "               ░  ░   ░     ░  ░    ░           ░       ░ \n";
		...
		static readonly string welcomeTXT =
		" ▄         ▄ ▄▄▄▄▄▄▄▄▄▄▄ ▄           ▄▄▄▄▄▄▄▄▄▄▄ ▄▄▄▄▄▄▄▄▄▄▄ ▄▄       ▄▄ ▄▄▄▄▄▄▄▄▄▄▄ \n" +
		"▐░▌       ▐░▐░░░░░░░░░░░▐░▌         ▐░░░░░░░░░░░▐░░░░░░░░░░░▐░░▌     ▐░░▐░░░░░░░░░░░▌\n" +
		"▐░▌       ▐░▐░█▀▀▀▀▀▀▀▀▀▐░▌         ▐░█▀▀▀▀▀▀▀▀▀▐░█▀▀▀▀▀▀▀█░▐░▌░▌   ▐░▐░▐░█▀▀▀▀▀▀▀▀▀ \n" +
		"▐░▌       ▐░▐░▌         ▐░▌         ▐░▌         ▐░▌       ▐░▐░▌▐░▌ ▐░▌▐░▐░▌          \n" +
		...
		static void Main(string[] args)
		{
			...
			Thread.Sleep(1500);
			Console.Clear();
			Console.WriteLine(toTXT);
			Thread.Sleep(1000);
			Console.Clear();
			Console.WriteLine(bloodyPrague);
			Thread.Sleep(1500);
			Console.Clear();
			Console.WriteLine(bloodyParking);
			Thread.Sleep(1500);
			Console.Clear();
			Console.WriteLine(bloodyPragueParking);
			Thread.Sleep(3000);
			Console.Clear();
			int menuInput;
			do
